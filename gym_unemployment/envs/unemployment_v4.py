...
class UnemploymentLargeEnv_v4(gym.Env):
    ...
    def setup_default_params(self):
        ...
        self.osaaikatyonteko=0.675 # = 6kk
...
#                 print('ei saa elatustukea',children_under18,'lasta')
    ...
    def setup_couples(self,age,wage,old_wage,kansanelake,tyoelake,employment_state,time_in_state,used_unemp_benefit,
            children_under3,children_under7,children_under18,irtisanottu,karenssia_jaljella,
            puoliso_palkka,puoliso_old_wage,puoliso_kansanelake,puoliso_tyoelake,puoliso_tila,puoliso_time_in_state,puoliso_used_unemp_benefit,
            puoliso_irtisanottu,puoliso_karenssia_jaljella):
        
        p=self.setup_benefits(wage,old_wage,kansanelake,tyoelake,employment_state,time_in_state,age,used_unemp_benefit,
        ...
        p=self.setup_benefits(puoliso_palkka,puoliso_old_wage,puoliso_kansanelake,puoliso_tyoelake,puoliso_tila,puoliso_time_in_state,age,puoliso_used_unemp_benefit,
                  children_under3,children_under7,children_under18,puoliso=1,
    ...
    def comp_benefits(self,wage : float,old_wage : float,kansanelake : float,tyoelake : float,employment_state : int,
        ...
        if puoliso>0 and not (employment_state==15 or puoliso_tila==15): # pariskunta
            p=self.setup_couples(ika,wage,old_wage,kansanelake,tyoelake,employment_state,time_in_state,used_unemp_benefit,
                    children_under3,children_under7,children_under18,irtisanottu,karenssia_jaljella,
                    puoliso_palkka,puoliso_old_wage,puoliso_kansanelake,puoliso_tyoelake,puoliso_tila,puoliso_time_in_state,puoliso_used_unemp_benefit,
                    puoliso_irtisanottu,puoliso_karenssia_jaljella)
            ...
            if self.include_emtr:
                ...
                if employment_state in emtr_tilat:
                    ...
                    if False:
                        ...
                        if tvax<1.0:
                            print('co omat tvax<1',employment_state,w0,w1,tvax) 
                        if effx<1.0:
                            print('co omat effx<1',employment_state,w0,w1,effx) 
                else:
                ...
                if puoliso_tila in emtr_tilat:
                    ...
                    pp0=self.setup_couples(ika,wage,old_wage,kansanelake,tyoelake,employment_state,time_in_state,used_unemp_benefit,
                            children_under3,children_under7,children_under18,irtisanottu,karenssia_jaljella,
                            pw0,pow0,puoliso_kansanelake,puoliso_tyoelake,pe0,0,puoliso_used_unemp_benefit,
                            puoliso_irtisanottu,puoliso_karenssia_jaljella)
                    pp1=self.setup_couples(ika,wage,old_wage,kansanelake,tyoelake,employment_state,time_in_state,used_unemp_benefit,
                            children_under3,children_under7,children_under18,irtisanottu,karenssia_jaljella,
    ...
    def move_to_parttime(self,wage : float,pension : float,tyoelake : float,old_wage : float,age : float,tyoura : float,time_in_state : float,
        ...
        parttimewage=self.osaaikatyonteko*wage
    ...
    def move_to_oa_parttime(self,wage : float,pension : float,old_wage : float,age : float,kansanelake : float,tyoelake : float,employment_status : float,
        ...
        if age>=self.max_retirementage: # move to retirement state 2
            ...
            time_in_state=self.timestep
            alkanut_ansiosidonnainen=0
            ptwage=self.osaaikatyonteko*wage
    ...
    def stay_employed(self,wage,employment_status,kansanelake,tyoelake,pension,time_in_state,toe,toekesto,
        ...
        if action == 0 or action == 5:
            ...
            print(f'error 12 (action {action})')    
    ...
    def stay_retired(self,wage,employment_status,kansanelake,tyoelake,pension,time_in_state,toe,toekesto,
        ...
        if age >= self.min_retirementage: # ve
            ...
            if action == 0:
                ...
                print(f'error 121: unknown action for outsider in retired (action {action})')    
    ...
    def stay_parttime(self,wage,employment_status,kansanelake,tyoelake,pension,time_in_state,toe,toekesto,
        ...
        if action == 0 or action == 5:
            ...
            print(f'error 122 (action {action})')    
    ...
    def get_benefits(self,empstate,wage,kansanelake,tyoelake,pension,time_in_state,pinkslip,old_wage,unempwage,
                        ...
                        puoliso,puoliso_tila,spouse_wage,puoliso_kansanelake,puoliso_tyoelake,puoliso_old_wage,
        ...
        if empstate==0:
            ...
            parttimewage=self.osaaikatyonteko*pot_wage
            wage=parttimewage
            old_wage=0
        elif empstate==9:
            wage=pot_wage
        ...
        if puoliso_tila==0:
            ...
            puoliso_palkka=0
            puoliso_old_wage=max(puoliso_unempwage,0.5*(spouse_wage+puoliso_old_wage)) # ei tarkkaa laskentaa
        elif puoliso_tila==6:
            puoliso_palkka=0
            puoliso_old_wage=max(puoliso_unempwage,0.5*(spouse_wage+puoliso_old_wage)) # ei tarkkaa laskentaa
        elif puoliso_tila==7:
            ...
            spouse_parttimewage=self.osaaikatyonteko*spouse_wage
    ...
    def update_wage_reduction_sigma(self,state,wage_reduction,pinkslip,time_in_state,initial_reduction=False):
        ...
        if state in set([1]): # töissä
            ...
            wage_reduction=max(min_reduction,1.0-(1.0-self.salary_const_outsider)*(1.0-wage_reduction))
...
#         
    ...
    def step(self, action, dynprog=False, debug=False):
        ...
        if False: # used for emtr
            pot_wage=self.get_potential_wage(age)
            pot_spouse_wage=self.get_potential_spousewage(age)                
        else:
            pot_wage=wage
        ...
        if self.randomness:
            ...
            if sattuma[0]<move_prob:
                ...
                if sattuma[2]<s2/move_prob: # vanhempainvapaa
                    ...
                    if not employment_status in set([3,15]):
...
#         self.men_kappa_osaaika_middle=0.703 # vapaa-ajan menetyksestä rangaistus miehille osa-aikatyön teosta, suhteessa kokoaikaan
#         #self.men_kappa_osaaika_old=0.62 # vapaa-ajan menetyksestä rangaistus miehille osa-aikatyön teosta, suhteessa kokoaikaan
#         self.men_kappa_osaaika_old=0.652 # self.men_kappa_osaaika_middle
...
#         
#         self.women_kappa_fulltime=0.573 # vapaa-ajan menetyksestä rangaistus naisille
...
#         self.women_kappa_osaaika_old=0.503 # self.women_kappa_osaaika_middle
...
#         self.kappa_svpaivaraha=0.5
    ...
    def log_utility_mort_ove_params(self):
        ...
        self.salary_const=0.04*self.timestep # 0.038 työttämyydestä palkka alenee tämän verran vuodessa
        self.salary_const_outsider=0.10*self.timestep # 0.038 työttämyydestä palkka alenee tämän verran vuodessa
        self.salary_const_retirement=0.10*self.timestep # vanhuuseläkkeellä muutos nopeampaa
        self.salary_const_svpaiva=0.25*self.timestep # pitkällä svpäivärahalla muutos nopeaa
        self.salary_const_up=0.030*self.timestep # 0.04 työssäolo palauttaa ansioita tämän verran vuodessa
        self.salary_const_up_osaaika=0.030*self.timestep # 0.04 osa-aikainen työssäolo palauttaa ansioita tämän verran vuodessa
        self.salary_const_student=0.01*self.timestep # 0.05 opiskelu pienentää leikkausta tämän verran vuodessa
        self.wage_initial_reduction=0.015 # työttömäksi siirtymisestä tuleva alennus tuleviin palkkoihin, NOT USED!
        ...
        self.men_kappa_fulltime=0.650 # vapaa-ajan menetyksestä rangaistus miehille
        self.men_mu_scale_kokoaika=0.0155#263 #120 #0.075 # 0.075 #18 # 0.14 # 0.30 # 0.16 # how much penalty is associated with work increase with age after mu_age
        self.men_mu_scale_osaaika=0.006#173 #040 #0.075 # 0.075 #18 # 0.14 # 0.30 # 0.16 # how much penalty is associated with work increase with age after mu_age
        self.men_mu_age=self.min_retirementage-8.0 #5.5 # P.O. 60??
        self.men_kappa_osaaika_young=0.675 # vapaa-ajan menetyksestä rangaistus miehille osa-aikatyön teosta, suhteessa kokoaikaan
        self.men_kappa_osaaika_middle=0.750 # vapaa-ajan menetyksestä rangaistus miehille osa-aikatyön teosta, suhteessa kokoaikaan
        #self.men_kappa_osaaika_old=0.62 # vapaa-ajan menetyksestä rangaistus miehille osa-aikatyön teosta, suhteessa kokoaikaan
        self.men_kappa_osaaika_old=0.710 # self.men_kappa_osaaika_middle
        self.men_kappa_osaaika_pension=0.65
        self.men_kappa_hoitovapaa=0.085 # hyäty hoitovapaalla olosta
        self.men_kappa_ve=0.45
        self.men_kappa_pinkslip_young=0.35
        self.men_kappa_pinkslip_middle=0.15
        self.men_kappa_pinkslip_elderly=0.20
        
        self.women_kappa_fulltime=0.520 # vapaa-ajan menetyksestä rangaistus naisille
        self.women_mu_scale_kokoaika=0.0155#263 #120 #0.075 # 0.075 # 0how much penalty is associated with work increase with age after mu_age
        self.women_mu_scale_osaaika=0.006#173 #040 #0.075 # 0.075 # 0how much penalty is associated with work increase with age after mu_age
        self.women_mu_age=self.min_retirementage-4.0 #4.0 # 61 #5 P.O. 60??
        self.women_kappa_osaaika_young=0.575
        self.women_kappa_osaaika_middle=0.668
        #self.women_kappa_osaaika_old=0.48
        self.women_kappa_osaaika_old=0.650 # self.women_kappa_osaaika_middle
        self.women_kappa_osaaika_pension=0.55
        self.women_kappa_hoitovapaa=0.300 # 0.27
        self.women_kappa_ve=0.45
        self.women_kappa_pinkslip_young=0.35
        self.women_kappa_pinkslip_middle=0.20
        self.women_kappa_pinkslip_elderly=0.20   
        self.kappa_svpaivaraha=0.5
...
#             return 0
    ...
    def get_onehot(self,vec,a,n):
        ...
        g=int(g)
        if g<0:
            print(f'state error at {a} len {n}:'+str(vec[a:a+n]))
    ...
    def state_decode(self,vec):
        ...
        pos=0
        emp=self.get_onehot(vec,pos,self.n_empl)
        pos+=self.n_empl
        g=self.get_onehot(vec,pos,self.n_groups)
        pos+=self.n_groups
        g=int(g)
        ...
        puoliso_tila=self.get_onehot(vec,pos+27,self.n_spouseempl)
        ...
        return emp,g,pension,wage,age,time_in_state,paid_pension,pink,toe,toekesto,\
...
#                 reset_exp=True
    ...
    def update_infostate(self,t : int,state : int,wage : float,unempbasis : float,is_spouse=False):
        ...
        if state==1:
            ...
            self.infostate[palkka][t]=wage*self.osaaikatyonteko
        elif state in set([5,6]):
            self.infostate[palkka][t]=wage
        else:
