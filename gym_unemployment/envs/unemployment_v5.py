...
class UnemploymentLargeEnv_v5(gym.Env):
    ...
    def update_wage_reduction_sigma(self,state,wage_reduction,pinkslip,time_in_state,g,initial_reduction=False):
        ...
        if state in set([1]): # töissä
            ...
            #wage_reduction=0.60 # vastaa määritelmää
            wage_reduction=wage_reduction # vastaa määritelmää
    ...
    def step(self, action, dynprog=False, debug=False):
        ...
        if age>=self.max_retirementage and main_empstate not in set([2,3,15]):
            main_empstate,kansanelake,tyoelake_maksussa,main_pension,main_paid_wage,time_in_state,ove_paid,main_basis_wage\
                =self.move_to_retirement(main_pension,0,age,kansanelake,tyoelake_maksussa,
        ...
        self.state = self.state_encode(main_empstate,g,main_pension,main_wage,age,time_in_state,
...
#  Perussetti, tuottaa korkean elastisuuden
    ...
    def log_utility_mort_ove_params(self):
        ...
        self.men_kappa_param=np.array([-0.455, -0.459, -0.465, -0.635, -0.900, -1.380]) # osa-aika 10h, 20h, 30h, kokoaika 40h, 50h, 60h
        ...
        self.women_kappa_param=np.array([-0.223, -0.215, -0.235, -0.370, -0.725, -0.975]) # osa-aika 10h, 20h, 30h, kokoaika 40h, 50h, 60h
