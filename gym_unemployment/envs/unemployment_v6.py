...
from . state_v6 import Statevector_v6
...
class UnemploymentLargeEnv_v6(gym.Env):
    """
    Description:
    ...
    def __init__(self,**kwargs) -> None:
        ...
        self.states=Statevector_v6(self.n_empl,self.n_groups,self.n_parttime_action,self.include_mort,self.min_age,self.max_age,self.include_preferencenoise,self.min_retirementage,self.min_ove_age,self.get_paid_wage,self.timestep)
    ...
    def set_year(self,year: int) -> None:
        ...
        self.student_inrate,self.student_outrate = self.rates.get_student_rate_v6() # myös armeijassa olevat tässä
        self.outsider_inrate,self.outsider_outrate = self.rates.get_outsider_rate_v6(self.min_retirementage)
    ...
    def comp_life_left(self,g: int,age: float) -> float:
        ...
        if self.plotdebug and True:
            print(f'For age {age} comp_life_left x: {x-age}')
...
#############################
    ...
    def move_to_oa_fulltime(self,wage: float,pt_action: int,pension: float,old_wage: float,age: float,kansanelake: float,
    ...
    def move_to_svraha(self,pension: float,tyoelake: float,ove_paid: int,is_spouse: bool=False):
        '''
    ...
    def move_to_disab(self,pension: float,old_wage: float,age: float,unemp_after_ra: float,kansanelake: float,tyoelake: float,ove_paid: int,has_spouse: int,children_under18: int,is_spouse: bool):
        '''
        Siirtymä työkyvyttämyyseläkkeelle aktiivista, ei eläkkeeltä
        '''
    ...
    def comp_familypension(self,puoliso: float,emp_state: int,spouse_empstate: int,tyoelake: float,pension: float,age: float,
                            puoliso_tyoelake: float,puoliso_pension: float,children_under18: int,has_spouse: bool,is_spouse: bool):
        '''
        Siirtymä työkyvyttämyyseläkkeelle aktiivista, ei eläkkeeltä
        '''
    ...
    def stay_unemployed(self,wage: float,paid_wage: float,pt_action: int,employment_status: int,
                        kansanelake: float,tyoelake: float,pension: float,time_in_state: float,toe: float,toekesto: float,
                        tyoura: float,used_unemp_benefit: float,pinkslip: int,unemp_after_ra: float,old_wage: float,unempwage: float,
    ...
    def stay_tyomarkkinatuki(self,wage: float,paid_wage: float,pt_action: int,employment_status: int,
                        kansanelake: float,tyoelake: float,pension: float,time_in_state: float,toe: float,toekesto: float,
                        tyoura: float,used_unemp_benefit: float,pinkslip: int,unemp_after_ra: float,old_wage: float,unempwage: float,
                        unempwage_basis: float,action: int,age: float,sattuma,intage: int,g: int ,alkanut_ansiosidonnainen: int,
                        toe58: int,ove_paid: int,children_under3: int,children_under18: int,basis_wage: float,has_spouse: int,is_spouse: bool):
    ...
    def stay_pipeline(self,wage: float,paid_wage: float,pt_action: int,employment_status: int,
                        kansanelake: float,tyoelake: float,pension: float,time_in_state: float,toe: float,toekesto: float,
                        tyoura: float,used_unemp_benefit: float,pinkslip: int,unemp_after_ra: float,old_wage: float,unempwage: float,
                        unempwage_basis: float,action: int,age: float,sattuma,intage: int,g: int ,alkanut_ansiosidonnainen: int,
                        toe58: int,ove_paid: int,children_under3: int,children_under18: int,basis_wage: float,has_spouse: int,is_spouse: bool):
    ...
    def stay_employed(self,wage: float,paid_wage: float,pt_action: int,employment_status: int,
                        kansanelake: float,tyoelake: float,pension: float,time_in_state: float,toe: float,toekesto: float,
                        tyoura: float,used_unemp_benefit: float,pinkslip: int,unemp_after_ra: float,old_wage: float,unempwage: float,
                        unempwage_basis: float,action: int,age: float,sattuma,intage: int,g: int ,alkanut_ansiosidonnainen: int,
                        toe58: int,ove_paid: int,children_under3: int,children_under18: int,basis_wage: float,has_spouse: int,is_spouse: bool):
        ...
        if action == 0: # or action == 5:
            ...
            if age >= self.min_retirementage:
                employment_status,kansanelake,tyoelake,pension,paid_wage,time_in_state,ove_paid,basis_wage=\
                    self.move_to_oa_fulltime(wage,pt_action,pension,old_wage,age,kansanelake,tyoelake,employment_status,
                        unemp_after_ra,scale_acc=True,has_spouse=has_spouse,is_spouse=is_spouse)
            else:
                if (not ove_paid) and (age>self.min_ove_age):
                    pension,tyoelake,ove_paid = self.move_to_ove(employment_status,pension,tyoelake,ove_paid,age,unemp_after_ra)
...
#                    self.move_to_parttime(wage,pt_action,pension,tyoelake,old_wage,age,tyoura,unemp_after_ra,has_spouse=has_spouse,is_spouse=is_spouse)
    ...
    def stay_disabled(self,wage: float,paid_wage: float,pt_action: int,employment_status: int,
                        kansanelake: float,tyoelake: float,pension: float,time_in_state: float,toe: float,toekesto: float,
                        tyoura: float,used_unemp_benefit: float,pinkslip: int,unemp_after_ra: float,old_wage: float,unempwage: float,
                        unempwage_basis: float,action: int,age: float,sattuma,intage: int,g: int ,alkanut_ansiosidonnainen: int,
                        toe58: int,ove_paid: int,children_under3: int,children_under18: int,basis_wage: float,has_spouse: int,is_spouse: bool):
    ...
    def stay_retired(self,wage: float,paid_wage: float,pt_action: int,employment_status: int,
                        kansanelake: float,tyoelake: float,pension: float,time_in_state: float,toe: float,toekesto: float,
                        tyoura: float,used_unemp_benefit: float,pinkslip: int,unemp_after_ra: float,old_wage: float,unempwage: float,
                        unempwage_basis: float,action: int,age: float,sattuma,intage: int,g: int ,alkanut_ansiosidonnainen: int,
                        toe58: int,ove_paid: int,children_under3: int,children_under18: int,basis_wage: float,has_spouse: int,is_spouse: bool):
        ...
        if age >= self.min_retirementage: # ve
            ...
            if age >= self.max_retirementage:
                ...
                if wage<1.0:
                    print(f'ret state {employment_status} wage {wage} paid_wage {paid_wage} age {age} is_spouse {is_spouse}')
                    self.render()
    ...
    def stay_motherleave(self,wage: float,paid_wage: float,pt_action: int,employment_status: int,
                        kansanelake: float,tyoelake: float,pension: float,time_in_state: float,toe: float,toekesto: float,
                        tyoura: float,used_unemp_benefit: float,pinkslip: int,unemp_after_ra: float,old_wage: float,unempwage: float,
                        unempwage_basis: float,action: int,age: float,sattuma,intage: int,g: int ,alkanut_ansiosidonnainen: int,
                        toe58: int,ove_paid: int,children_under3: int,children_under18: int,basis_wage: float,has_spouse: int,is_spouse: bool):
    ...
    def stay_fatherleave(self,wage: float,paid_wage: float,pt_action: int,employment_status: int,
                        kansanelake: float,tyoelake: float,pension: float,time_in_state: float,toe: float,toekesto: float,
                        tyoura: float,used_unemp_benefit: float,pinkslip: int,unemp_after_ra: float,old_wage: float,unempwage: float,
                        unempwage_basis: float,action: int,age: float,sattuma,intage: int,g: int ,alkanut_ansiosidonnainen: int,
                        toe58: int,ove_paid: int,children_under3: int,children_under18: int,basis_wage: float,has_spouse: int,is_spouse: bool):
    ...
    def stay_kht(self,wage: float,paid_wage: float,pt_action: int,employment_status: int,
                kansanelake: float,tyoelake: float,pension: float,time_in_state: float,toe: float,toekesto: float,
                tyoura: float,used_unemp_benefit: float,pinkslip: int,unemp_after_ra: float,old_wage: float,unempwage: float,
                unempwage_basis: float,action: int,age: float,sattuma,intage: int,g: int ,alkanut_ansiosidonnainen: int,
                toe58: int,ove_paid: int,children_under3: int,children_under18: int,basis_wage: float,has_spouse: int,is_spouse: bool):
    ...
    def stay_student(self,wage: float,paid_wage: float,pt_action: int,employment_status: int,
                        kansanelake: float,tyoelake: float,pension: float,time_in_state: float,toe: float,toekesto: float,
                        tyoura: float,used_unemp_benefit: float,pinkslip: int,unemp_after_ra: float,old_wage: float,unempwage: float,
                        unempwage_basis: float,action: int,age: float,sattuma,intage: int,g: int ,alkanut_ansiosidonnainen: int,
                        toe58: int,ove_paid: int,children_under3: int,children_under18: int,basis_wage: float,has_spouse: int,is_spouse: bool):
    ...
    def stay_oa_parttime(self,wage: float,paid_wage: float,pt_action: int,employment_status: int,
                        kansanelake: float,tyoelake: float,pension: float,time_in_state: float,toe: float,toekesto: float,
                        tyoura: float,used_unemp_benefit: float,pinkslip: int,unemp_after_ra: float,old_wage: float,unempwage: float,
                        unempwage_basis: float,action: int,age: float,sattuma,intage: int,g: int ,alkanut_ansiosidonnainen: int,
                        toe58: int,ove_paid: int,children_under3: int,children_under18: int,basis_wage: float,has_spouse: int,is_spouse: bool):
    ...
    def stay_oa_fulltime(self,wage: float,paid_wage: float,pt_action: int,employment_status: int,
                        kansanelake: float,tyoelake: float,pension: float,time_in_state: float,toe: float,toekesto: float,
                        tyoura: float,used_unemp_benefit: float,pinkslip: int,unemp_after_ra: float,old_wage: float,unempwage: float,
                        unempwage_basis: float,action: int,age: float,sattuma,intage: int,g: int ,alkanut_ansiosidonnainen: int,
                        toe58: int,ove_paid: int,children_under3: int,children_under18: int,basis_wage: float,has_spouse: int,is_spouse: bool):
    ...
    def stay_parttime(self,wage: float,paid_wage: float,pt_action: int,employment_status: int,
                        kansanelake: float,tyoelake: float,pension: float,time_in_state: float,toe: float,toekesto: float,
                        tyoura: float,used_unemp_benefit: float,pinkslip: int,unemp_after_ra: float,old_wage: float,unempwage: float,
                        unempwage_basis: float,action: int,age: float,sattuma,intage: int,g: int ,alkanut_ansiosidonnainen: int,
                        toe58: int,ove_paid: int,children_under3: int,children_under18: int,basis_wage: float,has_spouse: int,is_spouse: bool):
    ...
    def stay_outsider(self,wage: float,paid_wage: float,pt_action: int,employment_status: int,
                        kansanelake: float,tyoelake: float,pension: float,time_in_state: float,toe: float,toekesto: float,
                        tyoura: float,used_unemp_benefit: float,pinkslip: int,unemp_after_ra: float,old_wage: float,unempwage: float,
                        unempwage_basis: float,action: int,age: float,sattuma,intage: int,g: int ,alkanut_ansiosidonnainen: int,
                        toe58: int,ove_paid: int,children_under3: int,children_under18: int,basis_wage: float,has_spouse: int,is_spouse: bool):
    ...
    def stay_svpaivaraha(self,wage: float,paid_wage: float,pt_action: int,employment_status: int,
                        kansanelake: float,tyoelake: float,pension: float,time_in_state: float,toe: float,toekesto: float,
                        tyoura: float,used_unemp_benefit: float,pinkslip: int,unemp_after_ra: float,old_wage: float,unempwage: float,
                        unempwage_basis: float,action: int,age: float,sattuma,intage: int,g: int ,alkanut_ansiosidonnainen: int,
                        toe58: int,ove_paid: int,children_under3: int,children_under18: int,basis_wage: float,has_spouse: int,is_spouse: bool):
    ...
    def move_to_mort(self,age: float,children_under3: int,children_under7: int,children_under18: int,g: int,puoliso: int,prefnoise: int):
        ...
        self.state = self.states.state_encode(employment_status,g,pension,wage,age,
...
#############################
    ...
    def step(self, action: int, dynprog: bool=False, debug: bool=False):
        ...
        main_empstate,g,main_pension,main_old_wage,age,time_in_state,main_paid_pension,pinkslip,toe,\
        ...
        main_paid_wage,main_pt_factor = self.get_paid_wage(main_wage,main_empstate,main_pt_action)
        ...
        if self.randomness: # can be disabled for testing purposes
            ...
            dis = self.disability_intensity[intage+1,g,main_empstate]
            move_prob=dis+self.birth_intensity[intage,g]+self.student_inrate[intage,g]+self.outsider_inrate[intage,g]

            if sattuma[0]<move_prob and not main_empstate != 15:
                ...
                if sattuma[2]<s2/move_prob: # vanhempainvapaa
                    if self.infostate_can_have_children(age) and not (main_empstate==15 or spouse_empstate==15): 
                        ...
                        if g>2: # naiset
                            if main_empstate not in set([3]): # entä 14 ??
                                main_empstate,main_pension,tyoelake_maksussa,main_paid_wage,time_in_state,pinkslip,main_basis_wage=\
                                    self.move_to_motherleave(main_pension,tyoelake_maksussa,age,False)
                                pinkslip=0
                                karenssia_jaljella=0
                                main_moved=True
                                ...
                                if sattuma[4]<0.39 and spouse_empstate not in set([3]): # orig 0.5
                                    spouse_empstate,puoliso_pension,spouse_tyoelake_maksussa,spouse_paid_wage,spouse_time_in_state,puoliso_pinkslip,spouse_basis_wage=\
                                        self.move_to_fatherleave(puoliso_pension,spouse_tyoelake_maksussa,age,True)
                            ...
                            if spouse_empstate not in set([3]): # entä 14 ??
                                spouse_empstate,puoliso_pension,tyoelake_maksussa,spouse_paid_wage,spouse_time_in_state,puoliso_pinkslip,spouse_basis_wage=\
                                    self.move_to_motherleave(puoliso_pension,spouse_tyoelake_maksussa,age,True)
                                puoliso_karenssia_jaljella=0
                                puoliso_pinkslip=0
                                puoliso_wage_reduction = self.update_wage_reduction(spouse_empstate,puoliso_wage_reduction,puoliso_pinkslip,spouse_time_in_state,g)
                                spouse_moved=True
                                if sattuma[4]<0.39 and main_empstate not in set([3]): # orig 0.5
                                    main_empstate,main_pension,tyoelake_maksussa,main_paid_wage,time_in_state,pinkslip,main_basis_wage=\
                                        self.move_to_fatherleave(main_pension,tyoelake_maksussa,age,False)
                                    karenssia_jaljella=0
                                    pinkslip=0
                    ...
                    if main_empstate in set([0,1,4,10,13]) and age<self.min_retirementage: # not in set([2,3,5,6,7,8,9,11,12,15]):
                        main_empstate,main_pension,tyoelake_maksussa,main_paid_wage,time_in_state,pinkslip,main_basis_wage=\
                            self.move_to_student(main_paid_wage,main_pension,tyoelake_maksussa,age,time_in_state,tyoura,pinkslip)
                        karenssia_jaljella=0
                        pinkslip=0
                        main_wage_reduction = self.update_wage_reduction(main_empstate,main_wage_reduction,pinkslip,time_in_state,g)
                        main_moved=True
                    ...
                    if main_empstate in set([0,1,4,10,12,13]) and age<self.min_retirementage: # not in set([2,3,5,6,7,8,9,11,15]):
                        ...
                        main_empstate,kansanelake,tyoelake_maksussa,main_pension,wage,time_in_state,ove_paid,main_basis_wage\
                             = self.move_to_retirement(main_pension,main_wage,age,kansanelake,tyoelake_maksussa,
            ...
            # siirtymät, tässä disability_intensity iässä age+1, koska ensin svpäivärahakausi
            dis = self.disability_intensity[intage+1,spouse_g,spouse_empstate]
            move_prob=dis+self.student_inrate[intage,spouse_g]+self.outsider_inrate[intage,spouse_g]
            ...
            if sattuma2[0]<move_prob and not spouse_moved and spouse_empstate!=15:
                ...
                if sattuma2[2]<s1/move_prob: # age<self.min_retirementage and 
                    ...
                    if spouse_empstate in set([0,1,4,10,13]) and age<self.min_retirementage: # not in et([2,3,5,6,7,8,9,11,12,15]):
                        spouse_empstate,puoliso_pension,spouse_tyoelake_maksussa,spouse_paid_wage,spouse_time_in_state,puoliso_pinkslip,puoliso_basis_wage=\
                            self.move_to_student(spouse_paid_wage,puoliso_pension,spouse_tyoelake_maksussa,
                                age,spouse_time_in_state,puoliso_tyoura,puoliso_pinkslip)
                        puoliso_karenssia_jaljella=0
                        puoliso_pinkslip=0
                        puoliso_wage_reduction = self.update_wage_reduction(spouse_empstate,puoliso_wage_reduction,puoliso_pinkslip,spouse_time_in_state,g)
                        spouse_moved=True
                    ...
                    if spouse_empstate in set([0,1,4,10,12,13]) and age<self.min_retirementage: # not in set([2,3,5,6,7,8,9,11,12,15]):
                        spouse_empstate,puoliso_pension,spouse_tyoelake_maksussa,spouse_paid_wage,spouse_time_in_state,puoliso_pinkslip,puoliso_basis_wage=\
                            self.move_to_outsider(puoliso_pension,spouse_tyoelake_maksussa)
                        puoliso_karenssia_jaljella=0
                        puoliso_pinkslip=0
                        puoliso_wage_reduction = self.update_wage_reduction(spouse_empstate,puoliso_wage_reduction,puoliso_pinkslip,spouse_time_in_state,g)
                        spouse_moved=True
                    elif spouse_empstate in set([8,9]):
                        spouse_empstate,spouse_kansanelake,spouse_tyoelake_maksussa,puoliso_pension,spouse_wage,spouse_time_in_state,puoliso_ove_paid,puoliso_basis_wage\
                             = self.move_to_retirement(puoliso_pension,spouse_wage,age,spouse_kansanelake,spouse_tyoelake_maksussa,
                                spouse_empstate,puoliso_unemp_after_ra,all_acc=False,scale_acc=False,has_spouse=puoliso,is_spouse=True)
                        puoliso_pinkslip=0
                        puoliso_wage_reduction = self.update_wage_reduction(spouse_empstate,puoliso_wage_reduction,puoliso_pinkslip,spouse_time_in_state,g)
                        spouse_moved=True
                        
            if main_life_left <= 0 and main_empstate!=15: 
            ...
            if spouse_life_left <= 0 and spouse_empstate!=15: 
                ...
                if puoliso>0: # avo- tai avioliitossa
                    ...
                    tyoelake_maksussa = self.comp_familypension(puoliso,spouse_empstate,main_empstate,
                        spouse_tyoelake_maksussa,puoliso_pension,age,tyoelake_maksussa,
                        main_pension,children_under18,puoliso,True)
                #self.plotdebug=True
                spouse_empstate,puoliso_pension,spouse_wage,spouse_time_in_state,puoliso,spouse_tyoelake_maksussa,puoliso_basis_wage=\
                    self.move_to_deceiced()
                spouse_moved=True
        else:
        ...
        if age >= self.max_retirementage and spouse_empstate not in set([2,3,15]):
            spouse_empstate,spouse_kansanelake,spouse_tyoelake_maksussa,puoliso_pension,spouse_paid_wage,spouse_time_in_state,puoliso_ove_paid,spouse_basis_wage\
                 = self.move_to_retirement(puoliso_pension,spouse_wage,age,spouse_kansanelake,spouse_tyoelake_maksussa,spouse_empstate,\
        ...
        if (not main_moved) and main_empstate != 15:
            ...
            unemp_after_ra,tyoura,used_unemp_benefit,unempwage_basis,alkanut_ansiosidonnainen,ove_paid,karenssia_jaljella,main_basis_wage\
                = self.map_stays[main_empstate](main_wage,main_paid_wage,main_pt_action,main_empstate,kansanelake,tyoelake_maksussa,
                               main_pension,time_in_state,toe,toekesto,
                               tyoura,used_unemp_benefit,pinkslip,unemp_after_ra,main_old_wage,unempwage,unempwage_basis,
        ...
        if (not spouse_moved) and spouse_empstate != 15:
            ...
            # jota sitten kutsutaan
            is_spouse=True
            spouse_empstate,spouse_kansanelake,spouse_tyoelake_maksussa,puoliso_pension,spouse_time_in_state,puoliso_pinkslip,\
            ...
            puoliso_karenssia_jaljella,spouse_basis_wage\
                = self.map_stays[spouse_empstate](spouse_wage,spouse_paid_wage,spouse_pt_action,spouse_empstate,spouse_kansanelake,spouse_tyoelake_maksussa,puoliso_pension,spouse_time_in_state,puoliso_toe,puoliso_toekesto,
...
#  Perussetti, tuottaa korkean elastisuuden
    ...
    def log_utility_mort_ove_det_params(self):
        ...
        self.men_mu_scale_kokoaika=0.0595 # 0.065 # how much penalty is associated with work increase with age after mu_age
        self.men_mu_scale_osaaika=0.00 #0.010 # how much penalty is associated with work increase with age after mu_age
        self.men_mu_age = self.min_retirementage - 1.5 # 1.0
        self.men_kappa_hoitovapaa=0.020 # hyöty henkilölle hoitovapaalla olosta
        self.men_kappa_ve=0.0
        self.men_kappa_pinkslip_young=0.14
        self.men_kappa_pinkslip_middle=0.24
        self.men_kappa_pinkslip_elderly=0.25
        #self.men_kappa_param=np.array([-0.490, -0.430, -0.485, -0.610, -0.870, -1.395]) # osa-aika 10h, 20h, 30h, kokoaika 40h, 50h, 60h
        self.men_kappa_param=np.array([-0.300, -0.340, -0.385, -0.550, -0.670, -0.940]) # osa-aika 8h, 16h, 24h, kokoaika 32h, 40h, 48h
        
        self.women_mu_scale_kokoaika=0.0785 #0.085 # how much penalty is associated with work increase with age after mu_age
        ...
        self.women_kappa_hoitovapaa=0.170 # 0.27
        self.women_kappa_ve=0.0
        self.women_kappa_pinkslip_young=0.12
        self.women_kappa_pinkslip_middle=0.20
        self.women_kappa_pinkslip_elderly=0.25
        self.women_kappa_param=np.array([-0.150, -0.170, -0.195, -0.370, -0.485, -0.840]) # osa-aika 8h, 16h, 24h, kokoaika 32h, 40h, 48h
        #self.women_kappa_param=np.array([-0.300, -0.235, -0.290, -0.435, -0.745, -1.155]) # osa-aika 10h, 20h, 30h, kokoaika 40h, 50h, 60h
    ...
    def log_utility(self,income: float,employment_state: int,age: float,g: int=0,pinkslip: int=0,prefnoise: int=0,spouse:int =0,debug: bool=False,pt_factor: float=0):
        '''
    ...
    def get_initial_state(self,puoliso: int,is_spouse:bool =False,g: int=-1):
        ...
        return employment_state,group,pension,old_wage,age,time_in_state,paid_pension,pink,toe,toekesto,tyohist,next_wage,\
            ...
            ove_paid,kassanjasenyys,kansanelake,tyoelake_maksussa,main_pt_action,main_paid_wage,basis_wage,lleft
    ...
    def init_state(self):
        ...
        employment_state,group,pension,old_wage,age,time_in_state,paid_pension,pink,toe,toekesto,tyohist,next_wage,\
            ...
            main_pt_action,main_paid_wage,main_basis_wage,main_life_left\
             = self.get_initial_state(puoliso)
        
        spouse_g = self.states.get_spouse_g(group)

        spouse_empstate,_,puoliso_pension,puoliso_old_wage,_,spouse_time_in_state,puoliso_paid_pension,puoliso_pink,puoliso_toe,\
            ...
            spouse_pt_action,spouse_paid_wage,spouse_basis_wage,spouse_life_left\
        ...
        if self.plotdebug:
            ...
            print(f'emp {spouse_empstate} g {spouse_g} old_wage {puoliso_old_wage} next_wage {puoliso_next_wage} age {age} kassanjäsen {kassanjasenyys}')
            print(f'main lf {main_life_left} years')
            print(f'spouse lf {spouse_life_left} years')
        ...
        self.state = self.states.state_encode(employment_state,group,pension,old_wage,age,
                                       ...
                                       puoliso,spouse_empstate,puoliso_old_wage,puoliso_pension,
                                       puoliso_wage_reduction,spouse_tyoelake_maksussa, puoliso_next_wage,
                                       puoliso_used_unemp_benefit,puoliso_unemp_benefit_left,
    ...
    def render(self,mode: str='human',close:bool =False,done:bool =False,reward: float=None,netto: float=None,render_omat: bool=True,
                render_puoliso: bool=True,benq: dict=None,netto_omat: float=None,netto_puoliso: float=None):
        '''
        Tulostus-rutiini
        '''
        emp,g,pension,wage,age,time_in_state,paid_pension,pink,toe,toekesto,tyohist,used_unemp_benefit,\
            ...
            puoliso,spouse_empstate,spouse_g,puoliso_old_wage,puoliso_pension,\
        ...
        main_paid_wage,pt_factor = self.get_paid_wage(wage,emp,pt_act) # CHECK! 
        ...
        out=f'{m}s{onpuoliso} {emp:2d} g {g:d} a {age:.2f} w {wage:.0f} (wp {main_paid_wage:.0f} pt {pt_act:d}) nw {next_wage:.0f}'+\
            ...
            f' pk {pink:d} lf{main_life_left:.1f} c{c3:.0f}/{c7:.0f}/{c18:.0f} k {kappa:.2f}'
        ...
        spouse_paid_wage,s_pt_factor = self.get_paid_wage(puoliso_old_wage,spouse_empstate,s_pt_act) # CHECK!
        kappa = self.log_get_kappa(age,spouse_g,spouse_empstate,puoliso_pink,s_pt_factor)
        ...
        puoliso=f'{m}ps{onpuoliso} {spouse_empstate:d} g {spouse_g:d} a {age:.2f} w {puoliso_old_wage:.0f} (wp {spouse_paid_wage:.0f} pt {s_pt_act:d}) nw {puoliso_next_wage:.0f} red {puoliso_wage_reduction:.2f} tis {spouse_time_in_state:.2f}'+\
                f' pen {puoliso_pension:.0f} paid_e {spouse_tyoelake_maksussa:.0f} {var} ueb {puoliso_used_unemp_benefit:.2f}'\
                ...
                f' pk {puoliso_pink:d} lf{spouse_life_left:.1f} k {kappa:.2f}'
    ...
    def __str___(self):
        ...
        emp,g,pension,wage,age,time_in_state,paid_pension,pink,toe,toekesto,tyohist,used_unemp_benefit,\
            wage_red,unemp_after_ra,unempwage,unempwage_basis,prefnoise,c3,c7,c18,\
            unemp_left,oikeus,toe58,ove_paid,jasen,\
            puoliso,spouse_empstat,spouse_g,puoliso_old_wage,puoliso_pension,\
            puoliso_wage_reduction,puoliso_paid_pension,puoliso_next_wage,\
            puoliso_used_unemp_benefit,puoliso_unemp_benefit_left,\
            puoliso_unemp_after_ra,puoliso_unempwage,puoliso_unempwage_basis,\
            puoliso_alkanut_ansiosidonnainen,puoliso_toe58,puoliso_toe,\
