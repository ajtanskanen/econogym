...
#  Perussetti, tuottaa korkean elastisuuden
    ...
    def log_utility_default_params(self):
        ...
        if self.include_mort:
            ...
            self.men_kappa_fulltime=0.705 # 0.675 #0.682 # 0.670 # vapaa-ajan menetyksestä rangaistus miehille
            ...
            self.men_kappa_osaaika_old=0.340 # vapaa-ajan menetyksestä rangaistus miehille osa-aikatyön teosta, suhteessa kokoaikaan, alle 35v
            ...
            self.women_kappa_osaaika=0.355
