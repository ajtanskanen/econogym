...
class SavingsEnv_v1(gym.Env):
    ...
    def __init__(self,**kwargs):
        ...
        # parametrejä
        #self.inflationfactor=1.0 # dummy
...
#  Perussetti, tuottaa korkean elastisuuden
    ...
    def log_utility_default_params(self):
        ...
        if self.include_mort:
            ...
            self.men_kappa_osaaika_middle=0.433 # vapaa-ajan menetyksestä rangaistus miehille osa-aikatyön teosta, suhteessa kokoaikaan
            ...
            self.women_kappa_fulltime=0.600 # 0.605 # 0.640 # 0.620 # 0.610 # vapaa-ajan menetyksestä rangaistus naisille
            ...
            self.women_kappa_osaaika_young=0.395
            self.women_kappa_osaaika_middle=0.383
...
#                 reset_exp=True
    ...
    def init_infostate(self,lapsia=0,lasten_iat=np.zeros(15),lapsia_paivakodissa=0,age=18):
        ...
        '''
        self.infostate={}
        self.infostate['states']=np.zeros((self.n_time,1))-1
        self.infostate['wage']=np.zeros((self.n_time,1))-1
        self.infostate['unempbasis']=np.zeros((self.n_time,1))-1
