...
from . state_v5 import Statevector_v5
...
class UnemploymentLargeEnv_v5(gym.Env):
    ...
    Employment states:
        ...
        16  Employed @ 125%
        17  Employed @ 150%
        18  Part-time employed @ 25%
        19  Part-time employed @ 50%
    ...
    def __init__(self,**kwargs) -> None:
        ...
        if self.include_mort: # and not self.mortstop:
            ...
            self.n_empl=20 # state of employment, 0,1,2,3,4
        else:
            if not self.silent:
        ...
        self.states=Statevector_v5(self.n_empl,self.n_groups,self.n_parttime_action,self.include_mort,self.min_age,self.max_age,self.include_preferencenoise,self.min_retirementage,self.min_ove_age,self.get_paid_wage,self.timestep)
    ...
    def setup_parttime_actions(self,debug : bool = False):
        actions=np.zeros((self.n_empl,1))
        if debug:
    ...
    def setup_default_params(self):
        ...
        #self.include_parttimeactions=False
    ...
    def setup_couples(self,age: int,wage: float,benefitbasis: float,kansanelake: float,tyoelake: float,
        employment_state: int,time_in_state: float,used_unemp_benefit: float,
            ...
            puoliso_tila: int,spouse_time_in_state: float,puoliso_used_unemp_benefit: float,
        ...
        p=self.setup_benefits(puoliso_palkka,puoliso_benefitbasis,spouse_kansanelake,puoliso_tyoelake,puoliso_tila,spouse_time_in_state,age,puoliso_used_unemp_benefit,
                  children_under3,children_under7,children_under18,puoliso=1,
    ...
    def comp_benefits(self,wage: float,benefitbasis: float,kansanelake: float,tyoelake: float,employment_state: int,
                    ...
                    puoliso: int,puoliso_tila: int,puoliso_palkka: float,spouse_kansanelake: float,puoliso_tyoelake: float,
        ...
        if puoliso>0 and not (employment_state==15 or puoliso_tila==15): # pariskunta
            p=self.setup_couples(ika,wage,benefitbasis,kansanelake,tyoelake,employment_state,time_in_state,used_unemp_benefit,
                    ...
                    puoliso_palkka,puoliso_benefitbasis,spouse_kansanelake,puoliso_tyoelake,puoliso_tila,spouse_time_in_state,puoliso_used_unemp_benefit,
            ...
            if self.include_emtr:
                ...
                if puoliso_tila in emtr_tilat:
                    ...
                    if pw1<1.0 or pw1<pw0+1.0:
                        print('co puoliso',puoliso_tila,pw0,pw1,ika,puoliso_palkka)                
                        self.render()
            ...
            if puoliso_tila in [5,6,7]:
                if employment_state not in [5,6,7] or (employment_state in [5,6,7] and p_g>g):
                    p2=self.setup_benefits(puoliso_palkka,puoliso_benefitbasis,spouse_kansanelake,puoliso_tyoelake,puoliso_tila,spouse_time_in_state,ika,puoliso_used_unemp_benefit,
            ...
            if netto2<1 and puoliso>0 and debug:
                print(f'netto<1, spouse {puoliso_tila}',puoliso_palkka,puoliso_benefitbasis,spouse_kansanelake,puoliso_tyoelake,spouse_time_in_state,ika)
...
#############################
    ...
    def move_to_parttime(self,wage: float,pension: float,tyoelake: float,old_wage: float,
    ...
    def move_to_oa_fulltime(self,wage: float,pension: float,old_wage: float,age: float,kansanelake: float,
            tyoelake: float,employment_status: int,unemp_after_ra: float,scale_acc=True,has_spouse=0,is_spouse=False):
        '''
    ...
    def move_to_oa_parttime(self,wage: float,pension: float,old_wage: float,age: float,kansanelake: float,tyoelake: float,employment_status: float,
            unemp_after_ra: float,scale_acc=True,has_spouse: int =0,is_spouse: bool =False):
        '''
        Siirtymä vanhuuseläkkeelle
        '''
        basis_wage=0
    ...
    def move_to_disab_state(self,pension,old_wage,age,unemp_after_ra,kansanelake,tyoelake,ove_paid,has_spouse,children_under18,is_spouse):
        ...
        if age<self.min_retirementage:
            ...
            #print('move_to_disab_state')
            #print('w5y',wage5y,'elake',tyoelake)
            #if is_spouse:
            ...
            #if wage5y<30000:
            #    print('sv',basis_wage)
            #    _=self.infostate_comp_svpaivaraha_1v(is_spouse=is_spouse,render=True)
            #    print('w5y')
            #    _,_=self.infostate_comp_5y_ave_wage(is_spouse=is_spouse,render=True)
    ...
    def stay_unemployed(self,wage: float,paid_wage: float,employment_status: int,
    ...
    def stay_tyomarkkinatuki(self,wage: float,paid_wage: float,employment_status: int,
                        kansanelake: float,tyoelake: float,pension: float,time_in_state: float,toe: float,toekesto: float,
                        tyoura: float,used_unemp_benefit: float,pinkslip: int,unemp_after_ra: float,old_wage: float,unempwage: float,
                        unempwage_basis: float,action: int,age: float,sattuma,intage: int,g: int ,alkanut_ansiosidonnainen: int,
                        toe58: int,ove_paid: int,children_under3: int,children_under18: int,basis_wage: float,has_spouse: int,is_spouse: bool):
    ...
    def stay_pipeline(self,wage: float,paid_wage: float,employment_status: int,
                        kansanelake: float,tyoelake: float,pension: float,time_in_state: float,toe: float,toekesto: float,
                        tyoura: float,used_unemp_benefit: float,pinkslip: int,unemp_after_ra: float,old_wage: float,unempwage: float,
                        unempwage_basis: float,action: int,age: float,sattuma,intage: int,g: int ,alkanut_ansiosidonnainen: int,
                        toe58: int,ove_paid: int,children_under3: int,children_under18: int,basis_wage: float,has_spouse: int,is_spouse: bool):
    ...
    def stay_employed(self,wage: float,paid_wage: float,employment_status: int,
                        kansanelake: float,tyoelake: float,pension: float,time_in_state: float,toe: float,toekesto: float,
                        tyoura: float,used_unemp_benefit: float,pinkslip: int,unemp_after_ra: float,old_wage: float,unempwage: float,
                        unempwage_basis: float,action: int,age: float,sattuma,intage: int,g: int ,alkanut_ansiosidonnainen: int,
                        toe58: int,ove_paid: int,children_under3: int,children_under18: int,basis_wage: float,has_spouse: int,is_spouse: bool):
...
#                    self.move_to_parttime(wage,pt_action,pension,tyoelake,old_wage,age,tyoura,unemp_after_ra,has_spouse=has_spouse,is_spouse=is_spouse)
    ...
    def stay_disabled(self,wage: float,paid_wage: float,employment_status: int,
                        kansanelake: float,tyoelake: float,pension: float,time_in_state: float,toe: float,toekesto: float,
                        tyoura: float,used_unemp_benefit: float,pinkslip: int,unemp_after_ra: float,old_wage: float,unempwage: float,
                        unempwage_basis: float,action: int,age: float,sattuma,intage: int,g: int ,alkanut_ansiosidonnainen: int,
                        toe58: int,ove_paid: int,children_under3: int,children_under18: int,basis_wage: float,has_spouse: int,is_spouse: bool):
    ...
    def stay_retired(self,wage: float,paid_wage: float,employment_status: int,
                        kansanelake: float,tyoelake: float,pension: float,time_in_state: float,toe: float,toekesto: float,
                        tyoura: float,used_unemp_benefit: float,pinkslip: int,unemp_after_ra: float,old_wage: float,unempwage: float,
                        unempwage_basis: float,action: int,age: float,sattuma,intage: int,g: int ,alkanut_ansiosidonnainen: int,
                        toe58: int,ove_paid: int,children_under3: int,children_under18: int,basis_wage: float,has_spouse: int,is_spouse: bool):
    ...
    def stay_motherleave(self,wage: float,paid_wage: float,employment_status: int,
                        kansanelake: float,tyoelake: float,pension: float,time_in_state: float,toe: float,toekesto: float,
                        tyoura: float,used_unemp_benefit: float,pinkslip: int,unemp_after_ra: float,old_wage: float,unempwage: float,
                        unempwage_basis: float,action: int,age: float,sattuma,intage: int,g: int ,alkanut_ansiosidonnainen: int,
                        toe58: int,ove_paid: int,children_under3: int,children_under18: int,basis_wage: float,has_spouse: int,is_spouse: bool):
    ...
    def stay_fatherleave(self,wage: float,paid_wage: float,employment_status: int,
                        kansanelake: float,tyoelake: float,pension: float,time_in_state: float,toe: float,toekesto: float,
                        tyoura: float,used_unemp_benefit: float,pinkslip: int,unemp_after_ra: float,old_wage: float,unempwage: float,
                        unempwage_basis: float,action: int,age: float,sattuma,intage: int,g: int ,alkanut_ansiosidonnainen: int,
                        toe58: int,ove_paid: int,children_under3: int,children_under18: int,basis_wage: float,has_spouse: int,is_spouse: bool):
    ...
    def stay_kht(self,wage: float,paid_wage: float,employment_status: int,
                kansanelake: float,tyoelake: float,pension: float,time_in_state: float,toe: float,toekesto: float,
                tyoura: float,used_unemp_benefit: float,pinkslip: int,unemp_after_ra: float,old_wage: float,unempwage: float,
                unempwage_basis: float,action: int,age: float,sattuma,intage: int,g: int ,alkanut_ansiosidonnainen: int,
                toe58: int,ove_paid: int,children_under3: int,children_under18: int,basis_wage: float,has_spouse: int,is_spouse: bool):
    ...
    def stay_student(self,wage: float,paid_wage: float,employment_status: int,
                        kansanelake: float,tyoelake: float,pension: float,time_in_state: float,toe: float,toekesto: float,
                        tyoura: float,used_unemp_benefit: float,pinkslip: int,unemp_after_ra: float,old_wage: float,unempwage: float,
                        unempwage_basis: float,action: int,age: float,sattuma,intage: int,g: int ,alkanut_ansiosidonnainen: int,
                        toe58: int,ove_paid: int,children_under3: int,children_under18: int,basis_wage: float,has_spouse: int,is_spouse: bool):
    ...
    def stay_oa_parttime(self,wage: float,paid_wage: float,employment_status: int,
                        kansanelake: float,tyoelake: float,pension: float,time_in_state: float,toe: float,toekesto: float,
                        tyoura: float,used_unemp_benefit: float,pinkslip: int,unemp_after_ra: float,old_wage: float,unempwage: float,
                        unempwage_basis: float,action: int,age: float,sattuma,intage: int,g: int ,alkanut_ansiosidonnainen: int,
                        toe58: int,ove_paid: int,children_under3: int,children_under18: int,basis_wage: float,has_spouse: int,is_spouse: bool):
    ...
    def stay_oa_fulltime(self,wage: float,paid_wage: float,employment_status: int,
                        kansanelake: float,tyoelake: float,pension: float,time_in_state: float,toe: float,toekesto: float,
                        tyoura: float,used_unemp_benefit: float,pinkslip: int,unemp_after_ra: float,old_wage: float,unempwage: float,
                        unempwage_basis: float,action: int,age: float,sattuma,intage: int,g: int ,alkanut_ansiosidonnainen: int,
                        toe58: int,ove_paid: int,children_under3: int,children_under18: int,basis_wage: float,has_spouse: int,is_spouse: bool):
    ...
    def stay_parttime(self,wage: float,paid_wage: float,employment_status: int,
                        kansanelake: float,tyoelake: float,pension: float,time_in_state: float,toe: float,toekesto: float,
                        tyoura: float,used_unemp_benefit: float,pinkslip: int,unemp_after_ra: float,old_wage: float,unempwage: float,
                        unempwage_basis: float,action: int,age: float,sattuma,intage: int,g: int ,alkanut_ansiosidonnainen: int,
                        toe58: int,ove_paid: int,children_under3: int,children_under18: int,basis_wage: float,has_spouse: int,is_spouse: bool):
    ...
    def stay_outsider(self,wage: float,paid_wage: float,employment_status: int,
                        kansanelake: float,tyoelake: float,pension: float,time_in_state: float,toe: float,toekesto: float,
                        tyoura: float,used_unemp_benefit: float,pinkslip: int,unemp_after_ra: float,old_wage: float,unempwage: float,
                        unempwage_basis: float,action: int,age: float,sattuma,intage: int,g: int ,alkanut_ansiosidonnainen: int,
                        toe58: int,ove_paid: int,children_under3: int,children_under18: int,basis_wage: float,has_spouse: int,is_spouse: bool):
    ...
    def get_benefits(self,empstate,wage,kansanelake,tyoelake,pension,time_in_state,pinkslip,unempwage,
                        ...
                        puoliso,puoliso_tila,spouse_wage,spouse_kansanelake,puoliso_tyoelake,
                        puoliso_pinkslip,puoliso_karenssia_jaljella,spouse_time_in_state,
        ...
        netto,benq,netto_omat,netto_puoliso=self.comp_benefits(wage,benefitbasis,kansanelake,tyoelake,empstate,tis,
                                ...
                                puoliso,puoliso_tila,puoliso_palkka,spouse_kansanelake,puoliso_tyoelake,spouse_benefitbasis,spouse_time_in_state,
...
#         return palkka
#         
    def update_family(self,puoliso: int,age: float,employment_status: int,puoliso_tila: int,sattuma):
        '''
    ...
    def get_paid_wage(self,wage,empstate):
...
#############################
    ...
    def step(self, action, dynprog: bool=False, debug: bool=False):
        '''
        ...
        if (not moved) and main_empstate != 15:
            ...
            unemp_after_ra,tyoura,used_unemp_benefit,unempwage_basis,alkanut_ansiosidonnainen,ove_paid,karenssia_jaljella,main_basis_wage\
                = self.map_stays[main_empstate](main_wage,main_paid_wage,main_empstate,kansanelake,tyoelake_maksussa,
        ...
        if (not spouse_moved) and spouse_empstate != 15:
            ...
            puoliso_karenssia_jaljella,spouse_basis_wage\
                = self.map_stays[spouse_empstate](spouse_wage,spouse_paid_wage,spouse_empstate,spouse_kansanelake,spouse_tyoelake_maksussa,puoliso_pension,spouse_time_in_state,puoliso_toe,puoliso_toekesto,
        ...
        #toe,toekesto,unempwage,children_under3,children_under7,children_under18=self.infostats.comp_infostats(age,is_spouse=False)
...
#  Perussetti, tuottaa korkean elastisuuden
    ...
    def log_utility_mort_ove_det_params(self):
        ...
        self.men_kappa_param=np.array([-0.44, -0.425, -0.480, -0.625, -0.890, -1.420]) # osa-aika 10h, 20h, 30h, kokoaika 40h, 50h, 60h
        ...
        self.women_kappa_param=np.array([-0.290, -0.235, -0.290, -0.430, -0.740, -1.150]) # osa-aika 10h, 20h, 30h, kokoaika 40h, 50h, 60h
    ...
    def log_utility_mort_ove_nondet_params(self):
        ...
        self.women_kappa_pinkslip_middle=0.20
        self.women_kappa_pinkslip_elderly=0.17
        self.women_kappa_param=np.array([-0.320, -0.305, -0.320, -0.340, -0.790, -1.150]) # osa-aika 10h, 20h, 30h, kokoaika 40h, 50h, 60h
        #self.women_kappa_param=np.array([-0.257, -0.240, -0.260, -0.375, -0.785, -1.120]) # osa-aika 10h, 20h, 30h, kokoaika 40h, 50h, 60h
    ...
    def init_state(self):
        ...
        puoliso_tila,_,puoliso_pension,puoliso_old_wage,_,spouse_time_in_state,puoliso_paid_pension,puoliso_pink,puoliso_toe,\
    ...
    def render(self,mode='human',close=False,done=False,reward=None,netto=None,render_omat=True,render_puoliso=True,benq=None,netto_omat=None,netto_puoliso=None):
        ...
        spouse_paid_wage,s_pt_factor=self.get_paid_wage(puoliso_old_wage,puoliso_tila,s_pt_act) # CHECK!
        kappa=self.log_get_kappa(age,spouse_g,puoliso_tila,puoliso_pink,s_pt_factor)

        if puoliso_tila in set([0,1,4,10,5,6,7,13,14]):
        ...
        puoliso=f'{m}ps{onpuoliso} {puoliso_tila:d} g {spouse_g:d} a {age:.2f} w {puoliso_old_wage:.0f} (wp {spouse_paid_wage:.0f} pt {s_pt_act:d}) nw {puoliso_next_wage:.0f} red {puoliso_wage_reduction:.2f} tis {spouse_time_in_state:.2f}'+\
    ...
    def infostate_comp_5y_ave_wage(self,is_spouse=False,render=False):
        emp_states={1,10}
        unemp_states={0,4}
        family_states={5,6}
        muu_states={7,12,13}
    ...
    def infostate_comp_svpaivaraha_1v(self,is_spouse=False,render=False):
        emp_states={1,10}
        unemp_states={0,4}
        family_states={5,6}
        muu_states={7,12,13}
    ...
    def test_swap(self,minage=18,maxage=70,n=100):
        r=self.randomness
